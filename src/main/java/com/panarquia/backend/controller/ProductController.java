...
public class ProductController {
	...
	@ApiMethod(path = "list", name = "listAll",
	...
	@ApiMethod(path = "product/{id}", name = "productById",
		    httpMethod = ApiMethod.HttpMethod.GET)
	...
	@ApiMethod(path = "create", name = "createProduct",
		    httpMethod = ApiMethod.HttpMethod.POST)
	public void createProduct(@Named("product") ICreateProductDTO productDTO){
